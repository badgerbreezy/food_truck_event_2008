...
class EventTest < Minitest::Test
  ...
  def test_it_can_find_total_inventory
    ...
    expected = {item1 => {quantity: 100, food_trucks: [food_truck1, food_truck2]}, item2 => {quantity: 7, food_trucks: [food_truck2]}, item4 => {quantity: 50, food_trucks: [food_truck2]}, item3 => {quantity: 35, food_trucks: [food_truck2, food_truck3]}}
